                    ...
                    <div class="left">
                        <ul>
                            <li v-for="val in musichouse" @click="musli(val.id)" :key="val.id">
                                ...
                                <span>{{val.name}}</span>
                                <img src="img/MV.png" alt="" v-if="val.mvid != 0 ? true : false"
                                @click.stop="getMv(val.mvid)">
                            </li>
                        </ul>
                    </div>
                    <div class="center">
...
.wy-player article .left ul li img:nth-of-type(2) {
  margin-left: 5px;
}
...
.wy-player article .center .cd .mvbox {
  position: absolute;
  top: 20%;
  left: 10%;
  width: 80%;
...
.wy-player article .center .cd .mvbox video {
  width: 100%;
  height: 100%;
}
